...
<h3>Reservaciones Olvidadas</h3>

<?php
$total = count($reservations);
echo 'Total reservaciones olvidadas: ', $total;
?>
...
<table width="1182" border="1">
  <tr>
	<td width="80">
		<?php
        echo anchor('reservations/viewNoShows/id_reservation', '#');
        ?>    
    </td>
    
    <td width="250">
        <?php
        echo anchor('reservations/viewNoShows/gLname', 'Cliente');
        ?>    
   	</td>
    
	<td width="160">
        <?php
        echo anchor('reservations/viewNoShows/checkIn', 'Fecha Check In');
        ?>    
   	</td>
    
	<td width="160">
        <?php
        echo anchor('reservations/viewNoShows/checkOut', 'Fecha Check Out');
        ?>    
   	</td>
    
	<td width="130">
        <?php
        echo anchor('reservations/viewNoShows/status', 'Estado');
        ?>    
  	</td>
