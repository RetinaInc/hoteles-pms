...
echo form_open('hotels/registerHotel2/'.$hotelId);
?>
...
echo anchor('hotels/deleteHotel/'.$hotelId, 'Cancelar', array('onClick' => "return confirm('Seguro que desea cancelar? Se perderá la información')"));
?>
