...
<table width="1182" border="1">
  <tr>
	<td width="80">
		<?php
        echo anchor('reservations/viewAllReservations/id_reservation', '#');
        ?>    
    </td>
    
    <td width="250">
        <?php
        echo anchor('reservations/viewAllReservations/gLname', 'Cliente');
        ?>    
   	</td>
    
	<td width="160">
        <?php
        echo anchor('reservations/viewAllReservations/checkIn', 'Fecha Check In');
        ?>    
   	</td>
    
	<td width="160">
        <?php
        echo anchor('reservations/viewAllReservations/checkOut', 'Fecha Check Out');
        ?>    
   	</td>
    
	<td width="130">
        <?php
        echo anchor('reservations/viewAllReservations/status', 'Estado');
        ?>    
  	</td>
