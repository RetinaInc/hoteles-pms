...
foreach ($guest as $row)
{
	...
	echo anchor(base_url().'guests/edit_guest/'.$row['ID_GUEST'],'Editar')."<br><br>"; 
...
<p><a href="<?php echo base_url().'guests/view_guests/'?>">Volver a Clientes</a></p>
<p><a href="<?php echo base_url().'reservations/view_pending_reservations/'?>">Volver a Reservaciones</a></p>
<p><a href="<?php echo base_url().'rooms/view_rooms/'?>">Volver a Habitaciones</a></p>
<p><a href="<?php echo base_url().'rooms/view_room_types/'?>">Volver a Tipos de habitaciones</a></p>